...
namespace CoreXF
{
    public class MaterialWebImage : SKCanvasView, IBindableImage
    {
        ...
        async void SetImageSrcAsync()
        {
            try
            {
                ...
                Debug.WriteLine("SST: Start loading "+ ImageSrc);
                ...
                using (var stream = await Source.GetStreamAsync())
                {
                    ...
                    Debug.WriteLine("SST: End loading, start decoding " + ImageSrc);
                    RawImage.Add(SKBitmap.Decode(stream), DisposeMode.Dispose);
                    Debug.WriteLine("SST: End decoding " + ImageSrc);
                    Device.BeginInvokeOnMainThread(() =>
                    {
                        InvalidateSurface();
                    });
        ...
        protected override void OnPaintSurface(SKPaintSurfaceEventArgs e)
        {
            ...
            {
                Material.DrawImage(e.Surface, e.Info.Rect, this);
            }
            else
            {
